  ...
  def ransack_field(path_of_model, attribute_name, f, caption = nil)
    ...
    case type_of_column
      when :date, :datetime then
        ...
        # Greater than     (if u want to have calendar drop down, change datepicker to dpicker)
        ...
        # Less than            (if u want to have calendar drop down, change datepicker to dpicker)
        response += '<div class="input-prepend input-append input-' + type_of_column.to_s + '">'
